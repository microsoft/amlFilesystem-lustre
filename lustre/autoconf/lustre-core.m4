...
LB_CHECK_COMPILE([if struct address_space_operations() has migrate_folio()],
...
tmp_flags="$EXTRA_KCFLAGS"
EXTRA_KCFLAGS="-Werror"
LB_CHECK_COMPILE([if vfs_setxattr() value argument is non-const],
...
tmp_flags="$EXTRA_KCFLAGS"
EXTRA_KCFLAGS="-Werror"
LB_CHECK_COMPILE([if iov_iter_get_pages_alloc2() is available],
